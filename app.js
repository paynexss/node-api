...
function buildLocalData(obj){
    ...
    switch (platform) {
        case 'stormSniffer':
            ...
            let retStr = `{"uid": "${uid}", "isVip": 1, "member_type": 1, "member_title": "https://t.me/fhxueyue", "expire_on": "\u6c38\u4e45\u6709\u6548", "auth_quantity": 999999, "function_list": [1, 2, 3, 4, 5], "timestamp": ${t}, "ts": 0}`
